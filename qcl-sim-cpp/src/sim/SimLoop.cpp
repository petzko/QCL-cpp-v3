...
void startSim(char* simFile,char* setFile){
	...
	dat.E13 = (dat.HTB[dat.INJ][dat.INJ]-dat.HTB[dat.ULL][dat.ULL])/dat.hbar; // rad/ps; 1->3 traisition freq
	dat.E12 = (dat.HTB[dat.INJ][dat.INJ]-dat.HTB[dat.LLL][dat.LLL])/dat.hbar; // rad/ps; 1->2 transition freq
	dat.E32 = (dat.HTB[dat.ULL][dat.ULL]-dat.HTB[dat.LLL][dat.LLL])/dat.hbar; // rad/ps  3->2 transition freq (optical transition)
