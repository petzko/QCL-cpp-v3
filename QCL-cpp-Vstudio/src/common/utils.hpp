...
//#include <mkl.h>
#define _MATLAB_SUPPORT_ // if matlab support as a whole is supposed to be added ! 

#ifdef _MATLAB_SUPPORT_
#define _DISP_COMPENSATE_ // if you would like to use matlab fftroutines for disp compensation! 
//#define _MATLAB_PLOT_ // if you want to see the e-field plotted!
...
#endif // _MATLAB_SUPPORT_ 



template<typename _Tp>
void copyData( _Tp const * cFROM, _Tp * cTO, size_t LEN){
// seems to be faster than a call to cblas! 
